...
#include "Edu_Form_Factors.h"
#include <cmath>
#include "Edu_Parameters_GeV.h"
#include <iostream>
...
Form_Factors_Delta::Form_Factors_Delta() {
    this->mn = Edu_Param::mp;
    this->mn2 = Edu_Param::mp2;
    this->mDelta = Edu_Param::mDelta;
    this->mDelta2 = this->mDelta*this->mDelta;
    this->N_Delta_MA = Edu_Param::N_Delta_MA;
    this->aNC = 1.0 - 2.0*Edu_Param::sinw2;
...
void Form_Factors_Delta::setFF(double Q2) {
    ...
    double Fq = 1.0/((1.0 + Q2/Edu_Param::parameter_071)*(1.0 + Q2/Edu_Param::parameter_071));
    double AM = Edu_Param::parameter_03*(1.0 + Edu_Param::parameter_001*Q2)*exp(-Edu_Param::parameter_023*Q2)*(qcm/this->kgcm0)*Fq;
    double A32= sqrt(3.0)/2.0*(-AM);

    double r = sqrt(2.0*this->kgcm0/Edu_Param::pi/Edu_Param::alpha*this->mn*this->mDelta/(this->mmw2+Q2));
